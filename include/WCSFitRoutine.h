...
public:
    ...
    WCSFit(Fields &fields_, std::vector<std::shared_ptr<Instrument>> instruments_, ExposuresHelper exposures_,
           std::vector<int> extensionExposureNumbers, std::vector<int> extensionDevices,
           astrometry::YAMLCollector inputYAML, std::vector<std::shared_ptr<astrometry::Wcs>> wcss,
    ...
    void setExposures(std::vector<std::unique_ptr<Exposure>> expos, double sysErr, double refSysErr);
